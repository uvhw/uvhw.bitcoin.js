...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s graviocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  graviocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded graviocoin transaction") + "\n" +
              "  graviocoin-tx [options] -create [commands]   " + _("Create hex-encoded graviocoin transaction") + "\n" +
              "\n";
