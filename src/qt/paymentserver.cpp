...
const char* BIP71_MIMETYPE_PAYMENT = "application/graviocoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/graviocoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/graviocoin-paymentrequest";
